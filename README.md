...
Лицензия пока не выбрана. До добавления файла `LICENSE` проект следует считать опубликованным как исходный код без явно предоставленных прав на использование, изменение и распространение.

...
В project-архив `v1.2.0` по решению владельца релиза намеренно включены подготовленные `playlist.m3u` и `app.dat` как стартовый плейлист и состояние приложения.

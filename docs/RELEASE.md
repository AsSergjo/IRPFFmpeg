...
Начиная с `v1.1.0`, версионные релизы должны включать только файлы проекта. Не публикуйте новый большой support-архив при изменении `.exe`, `Language/*.lng`, документации, загрузчика или других файлов проекта.
...
Начиная с `v1.2.1`, по решению владельца релиза в project-архивы намеренно включаются подготовленные `playlist.m3u` и `app.dat` как стартовый плейлист и состояние приложения.
...
- `cover_cache/`;
- `Rec/`;
- PNG-скриншоты README и `docs/assets/`;
